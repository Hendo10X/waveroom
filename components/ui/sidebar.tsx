    ...
    <div
      ...
      <div
        ...
        <div
          ...
          <UserProfileDialog
            trigger={
              <button type="button" className="block mt-auto w-full text-left">
                <div className="flex items-center gap-3 p-3 rounded-lg hover:bg-sidebar-accent cursor-pointer transition-colors">
                  ...
                  <div className="w-9 h-9 rounded-full bg-muted flex items-center justify-center font-bold text-lg">
